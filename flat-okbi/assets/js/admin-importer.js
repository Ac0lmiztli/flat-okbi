jQuery(document).ready(function($) {
    ...
    $form.on('submit', function(e) {
        ...
        // 'nonce' вже є в формі як приховане поле
    ...
    function processNextBatch() {
        ...
        $.ajax({
            ...
            data: {
                ...
                fok_import_nonce: $('#fok_import_nonce').val(), // ++ ВИПРАВЛЕНО ТУТ ++
    ...
    function finishImport() {
        ...
        // ++ НОВИЙ КОД: AJAX-запит для видалення тимчасового файлу ++
        if (importFilepath) {
            $.post(ajaxurl, {
                action: 'fok_cleanup_import_file',
                fok_import_nonce: $('#fok_import_nonce').val(),
                filepath: importFilepath
            }).done(function() {
