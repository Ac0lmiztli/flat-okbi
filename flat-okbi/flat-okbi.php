...
function fok_enqueue_admin_scripts( $hook_suffix ) {
    ...
    // ЗМІНЕНО: Скрипти для редактора сітки тепер підключаються для "section"
    if ( 'section' === $current_screen->post_type ) {
        ...
        wp_enqueue_script( 'fok-admin-grid-editor-script', plugin_dir_url( __FILE__ ) . 'assets/js/admin-grid-editor.js', ['jquery', 'jquery-ui-draggable', 'jquery-ui-resizable', 'jquery-ui-droppable'], time(), true );
