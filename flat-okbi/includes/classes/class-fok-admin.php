...
class FOK_Admin {
    ...
    public function add_admin_list_filters() {
        ...
        if ( in_array($typenow, $property_types) ) {
            echo '<div class="fok-filter-group" data-dependency="apartment">
                    <label>' . __('Кількість кімнат', 'okbi-apartments') . '</label>
    ...
    /**
     * Gets a cached list of all residential complexes.
     */
