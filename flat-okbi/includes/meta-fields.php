...
if ( ! function_exists( 'fok_render_floor_row_template' ) ) {
    function fok_render_floor_row_template( $data = [] ) {
        ...
        ?>
        <div class="fok-floor-row">
            <span class="dashicons dashicons-menu handle"></span>
            <div class="fok-floor-fields">
                <div>
                    <label><?php _e( 'Номер поверху', 'okbi-apartments' ); ?></label>
                    <input type="text" class="fok-floor-number" value="<?php echo esc_attr( $number ); ?>">
                </div>
                <div>
                    <label><?php _e( 'Зображення плану', 'okbi-apartments' ); ?></label>
                    <div class="fok-image-preview"><?php if ( $image_src ) echo '<img src="' . esc_url( $image_src ) . '">'; ?></div>
                ...
                <div>
                    <label><?php _e( 'Дані полігонів (SVG Path)', 'okbi-apartments' ); ?></label>
                    <textarea class="fok-floor-polygons-data" rows="3"><?php echo esc_textarea( $polygons_data ); ?></textarea>
                </div>
                <div class="fok-floor-objects-wrapper">
                    <label><?php _e( 'Об\'єкти на цьому поверсі', 'okbi-apartments' ); ?></label>
