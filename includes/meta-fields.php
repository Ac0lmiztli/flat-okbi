    ...
    $meta_boxes[] = [
        ...
        'fields'     => [
            ...
            [
                ...
                'name' => 'Секція',
                'type' => 'post',
                'post_type' => 'section', // або як називається твій CPT для секцій
                ...
                'query_args' => [
                    ...
                    'meta_query' => [
                        [
                            'key' => 'fok_section_rc_link', // мета-поле, яке зв’язує секцію з ЖК
                            'value' => '', // значення буде підставлене з JS
                            'compare' => '='
                        ]
                    ]
                ]
            ],
            [ 'id' => 'fok_property_section_floor', 'name' => __( 'Поверх секції', 'okbi-apartments' ), 'type' => 'number', 'min' => 0, ],
