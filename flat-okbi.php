...
function fok_render_viewer_shortcode() {
    ...
    // --- Початок змін: Конвертація HEX в RGB для прозорості ---
    $rgb_color = '0, 115, 170'; // RGB для кольору за замовчуванням #0073aa
            ...
            <div id="fok-list-mode" class="active">
                <div class="fok-list-container">
                    <aside class="fok-list-sidebar">
                        ...
                        <h3><span class="dashicons dashicons-search"></span> <?php _e('Параметри пошуку', 'okbi-apartments'); ?></h3>
